...
vncpasswd - меняем пароль для подключения сеанса VNC (выполнять ТОЛЬКО!!! под пользователем vnc)
passwd vnc - меняем пароль для пользователя (можно выполнять под любым пользователем)
